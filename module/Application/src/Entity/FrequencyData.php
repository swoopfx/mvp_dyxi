...
class FrequencyData
{
    ...
    /**
     * Undocumented variable
     * @ORM\ManyToOne(targetEntity="FrequencyDataType")
     * @var FrequencyDataType
     */
     ...
     *
     * @param  string  $frequencyData  Undocumented variable
     *
     * @return  self
     */
    public function setFrequencyData(string $frequencyData)
    {
     ...
     * Set undocumented variable
     *
     * @param  FrequencyDataType  $frequencyDataType  Undocumented variable
     *
     * @return  self
     */
    public function setFrequencyDataType(FrequencyDataType $frequencyDataType)
    {
